      ...
      <div className="py-6 safe-top">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button 
            ...
            className="relative p-2 rounded-xl bg-secondary hover:bg-secondary/80 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
          >
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex gap-1">
              <Button variant="ghost" size="sm" onClick={() => setHistoryModalOpen(true)} aria-label="View history">
                <History className="w-4 h-4" />
              </Button>
              <Button variant="ghost" size="sm" onClick={() => setClearStatsOpen(true)} className="text-destructive" aria-label="Clear statistics">
