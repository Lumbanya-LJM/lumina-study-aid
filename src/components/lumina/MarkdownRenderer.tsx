...
const MarkdownRendererComponent: React.FC<MarkdownRendererProps> = ({ content, className, streaming }) => {
  ...
  // Memoize components to prevent re-mounting of all markdown elements on every update.
  // This is a major performance boost during AI streaming.
