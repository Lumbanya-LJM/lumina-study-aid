...
export const MarkdownRenderer: React.FC<MarkdownRendererProps> = React.memo(({ content, className, streaming }) => {
  ...
  // Memoize components to prevent re-mounting during streaming
