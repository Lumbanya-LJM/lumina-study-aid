...
// Performance Optimization: Import pages lazily to enable route-based code splitting.
...
// A lightweight fallback component to show while lazy-loaded pages are loading.
// Avoids a harsh layout shift or flash of a full-screen loader.
const PageLoader = () => (
