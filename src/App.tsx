...
// ⚡ Bolt: Code splitting all the pages to reduce the initial bundle size.
// This improves initial load time by only loading the code for the page the user is visiting.
