      ...
      <AuthProvider>
        <SchoolProvider>
          ...
          <BrowserRouter>
            ...
            {/*
              - Add Suspense for route-based code splitting.
              - This shows a loading spinner while the requested page's JavaScript is being fetched.
              - Improves initial load time by splitting the app into smaller chunks.
            */}
            <Suspense fallback={
