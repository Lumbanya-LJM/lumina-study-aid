...
// ⚡ Bolt: Use React.lazy for route-based code splitting.
// This defers the loading of each page's code until the user navigates to it,
// significantly reducing the initial bundle size and improving initial load time.
