// ⚡ Bolt: suspense and lazy loading were added to improve performance.
...
// ⚡ Bolt: The application's pages are now loaded lazily.
// This optimization, known as code-splitting, significantly reduces the initial bundle size.
// Instead of downloading all page code upfront, the browser only fetches the code for a specific page when the user navigates to it.
// This results in a much faster initial page load and a better user experience, especially on slower network connections.
// A SuspenseLoader is shown as a fallback while the page chunk is being downloaded.
