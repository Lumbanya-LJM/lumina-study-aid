...
// ⚡ Bolt: Dynamically import page components for route-based code splitting.
// This reduces the initial bundle size by loading pages on demand,
// significantly improving the application's initial load time.
      ...
      <AuthProvider>
        <SchoolProvider>
          ...
          <BrowserRouter>
            ...
            {/* ⚡ Bolt: Add Suspense to handle loading states for lazy-loaded pages. */}
            {/* This prevents a blank screen during route transitions and provides a */}
            {/* better user experience by showing a centered loading spinner. */}
