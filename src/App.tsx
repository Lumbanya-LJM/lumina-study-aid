...
// ⚡ Bolt: Implement route-based code splitting with React.lazy
// This improves initial load time by splitting the bundle into smaller, on-demand chunks.
            ...
            <SchoolProvider>
              <TooltipProvider>
                ...
                <BrowserRouter>
                  ...
                  {/* ⚡ Bolt: Add Suspense boundary for lazy-loaded routes. */}
                  {/* This shows a fallback UI while the page chunk is being loaded. */}
