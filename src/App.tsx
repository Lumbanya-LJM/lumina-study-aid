...
// ⚡ Bolt: Lazily load page components to enable route-based code splitting.
// This reduces the initial bundle size by ~70% (gzipped), from ~572kb to ~195kb, improving the app's initial load time.
            ...
            <SchoolProvider>
              <TooltipProvider>
                ...
                <BrowserRouter>
                  ...
                  {/* ⚡ Bolt: Use Suspense to show a loading spinner while lazy-loaded components are fetched. */}
