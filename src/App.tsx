...
// Performance Optimization: Lazy load page components to enable route-based code splitting.
// This reduces the initial bundle size, leading to faster initial page loads.
...
// A simple, centered loading spinner for the Suspense fallback.
// This is shown to the user while lazy-loaded components are being fetched.
