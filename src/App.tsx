      ...
      <AuthProvider>
        <SchoolProvider>
          ...
          <BrowserRouter>
            ...
            {/*
              Bolt's Optimization:
              - WHAT: Wrapped the Routes component in React.Suspense.
              - WHY: React.lazy() requires a Suspense boundary to render a fallback UI while the lazy-loaded component is being fetched. This prevents the application from crashing and provides a better user experience than a blank screen.
              - IMPACT: Enables route-based code splitting, significantly reducing the initial bundle size and improving the application's load time. The centered spinner provides a clean loading state, preventing layout shift.
            */}
