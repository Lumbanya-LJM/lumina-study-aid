...
// Eagerly load the splash screen to avoid a loading flash on the very first page view.
import SplashScreen from "./pages/SplashScreen";
import { supabase } from "@/integrations/supabase/client";

// All other pages are lazy-loaded to improve initial application load times.
