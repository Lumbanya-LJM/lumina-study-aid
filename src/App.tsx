...
// ⚡ Bolt: Use React.lazy to code-split page components.
// This reduces the initial bundle size, making the first page load faster.
// Pages are now fetched on-demand as the user navigates to them.
      ...
      <AuthProvider>
        <SchoolProvider>
          ...
          <BrowserRouter>
            ...
            {/* ⚡ Bolt: Add Suspense with a fallback UI.
                This prevents a blank screen while lazy-loaded components are fetched.
                The fallback is a simple, centered loading indicator to maintain a good UX. */}
            <Suspense
              fallback={
